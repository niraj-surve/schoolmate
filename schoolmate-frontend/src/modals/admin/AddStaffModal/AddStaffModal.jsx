...
const AddStaffModal = ({ isOpen, fetchStaff, closeModal }) => {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post(`${apiKey}/admin/add-staff`, requestData, config)
      .then((res) => {
        ...
        if (res.data.emailExistsError) {
          toast.error("Staff with same email already exists..!", {
            position: "bottom-right",
          });
        }
    ...
    >
      <DialogPanel>
        <div className="flex justify-between">
          <Title className="mb-8 text-primary">Add Staff</Title>
          <FaXmark
                ...
                <section className="flex flex-col">
                  ...
                  <label htmlFor="jobStartDate" className="text-sm">Job Start Date</label>
                    <input
                      ...
                      placeholder="Date of Job Started"
                      id="jobStartDate"
