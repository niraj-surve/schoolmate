...
const AddUniformsModal = ({
  ...
  const {
    ...
    defaultValues: {
      year: currentYear,
      noOfGirls: femaleCount,
      noOfBoys: maleCount,
      noOfTotalStudents: femaleCount + maleCount,
      uniformsReceivedByGirls: "",
      uniformsReceivedByBoys: "",
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post(`${apiKey}/user/staff/add-uniform-data`, requestData, config)
      .then((res) => {
        if (res.data.successful) {
          toast.success("Uniform Data added successfully..!", {
    ...
    >
      <DialogPanel>
        <div className="flex justify-between">
          <Title className="mb-8 text-primary">Add Uniform Data</Title>
          <FaXmark
...
export default AddUniformsModal;
